...
var canvas = document.getElementById('shanvas');
...
function setColour(colour, setButton=false) {
    strokeStyle = colour;
    if(setButton) {
        document.getElementById('pen').setAttribute("style", "background-color:"+colour+";border-color:"+colour);
    }
}
